...
4. Specifications
	...
	6. Additional components needed: 2 full BluePill devices needed, 3 LEDs (use the 7 Segment Display with PA3 for the decimal point, 01.PCF8574 for the segments), eight 220 Ohm resistors, 4.7kOhm resistor
5. References:    
