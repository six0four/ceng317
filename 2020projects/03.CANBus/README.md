...
4. Specifications
	...
	5. STM32 Pins, we will use jumpers to provide for connection options:
		...
		2. rear CANdevice: 3.3V, GND, PA11+PA12 (single ended bus), indicator LEDs+resistors PB12, PB13, and PB14 (jumper to disconnect power)
	6. Additional components needed: 2 full BluePill devices needed, 4.7kOhm resistor, LEDs, PB12, PB13, PB14: 3 LEDs, three 220 Ohm resistors), USB to 3.3V TTL Serial Cable
5. References:    
