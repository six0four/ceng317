...
2. I will make a USB serial device that will, that will receive input for an effector, via [Seeed Studio assembly](https://www.seeedstudio.com/fusion_pcb.html). This can be connected via a USB cable to a PC and PuTTY can be used for debugging. It can then also be connected to a Pi via USB but not necessarily this term. 
...
[Level shifters, N.B. at least one datasheet mentions connecting unused inputs to say GND](https://learn.adafruit.com/neopixels-on-raspberry-pi/raspberry-pi-wiring)   
