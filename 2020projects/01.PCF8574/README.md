...
4. Specifications
	...
	8. Additional components needed: two LEDs, three 4.7kOhm resistors, two 220 Ohm resistors, switch (perhaps use switch that is incorporated into the 04.ADC project joystick).
5. References:    
