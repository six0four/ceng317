...
4. Specifications
	...
	5. Protocol: I2C
	6. Footprint: 
	7. STM32 Pins used: 3.3V, GND, PB8, PB9, PC14
	8. Additional components needed: Beginning STM32 Figure 11-9 two LEDs, three 4.7kOhm resistors, two 220 Ohm resistors, switch (perhaps use switch that is incorporated into the 04.ADC project joystick).
5. References:    
